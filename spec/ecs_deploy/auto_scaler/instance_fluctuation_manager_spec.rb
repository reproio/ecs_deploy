...
RSpec.describe EcsDeploy::AutoScaler::InstanceFluctuationManager do
  ...
  describe "#increase" do
    context "w/o error" do
      ...
      it "succeeded to increase instances" do
        ...
        expect(log).to include("Succeeded to increase instance count!")
      end
    end
  end
  ...
  describe("#decrease") do
    context "w/o error" do
      before do
        ...
        availability_zones = [
          Aws::ECS::Types::Attribute.new(name: "ecs.availability-zone", value: "zone-1"),
          Aws::ECS::Types::Attribute.new(name: "ecs.availability-zone", value: "zone-2"),
          Aws::ECS::Types::Attribute.new(name: "ecs.availability-zone", value: "zone-3"),
          Aws::ECS::Types::Attribute.new(name: "ecs.availability-zone", value: "zone-4")
        ]
